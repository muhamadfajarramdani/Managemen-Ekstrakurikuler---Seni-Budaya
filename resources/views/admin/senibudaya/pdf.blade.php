<div class="container mt-4" data-aos="fade-down">
    <div class="bg-gradient text-center p-4 mb-4 rounded">
        <h1 class="mb-0 text-white">Daftar Senibudaya</h1>
    </div>
    ...
    <div class="row">
        @foreach ($senibudaya as $senbud)
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm border-primary card-custom">
                    <div class="card-header text-white text-center"
                        style="background: linear-gradient(90deg, #343a40, #9a8ab5);">
                        <h5 class="mb-0">{{ $senbud->nama }}</h5>
                    </div>
                    <div class="card-body">
                        <h6>Pembimbing: <span class="text-muted">{{ $senbud->pembimbing }}</span></h6>
                        <p><strong>Jadwal:</strong> <span class="text-muted">{{ $senbud->jadwal }}</span></p>
                    </div>
                </div>
            </div>
        @endforeach
